...
function RequestForm() {
    ...
    const requestPatch = async (request_id, message) => {
        try {
            const response = await axios.patch(`/api/request?request_id=${request_id}`, {
                message: message,
    ...
    const evaluatePatch = async (request_id, star ) => {
        try {
            const response = await axios.patch(`/api/member/star?request_id=${request_id}`, {
                star: star,
            });
    ...
    const sendConfirmReason = async (request_id) => {
        try {
            const response = await axios.patch(`/api/confirm`, {
                request_id: request_id,
                reasonForReFund: cancelReason,
            });
    ...
    async function WritePost() {
        ...
        try {
            const response = await axios.post(`/api/request-form?house_id=${house_id}`, formData, {
                headers: {
    ...
    //     try {
    //         const response = await axios.patch(`/api/balpoom-form`, formData, {
    //             headers: {
    //                 'Content-Type': 'multipart/form-data'
    //             }
    //         });
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (!write) {
                try {
                    // 매물 정보 가져오기
                    const response = await axios.get(`/api/test-imageget?request_id=${request_id}`);
